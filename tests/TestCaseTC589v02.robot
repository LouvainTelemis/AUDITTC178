...
Test My EventType With The Tab Search
    [Documentation]    Test and check the event name with the tab Search
    [Arguments]    ${MyEventName}
    ...
    Input Text    ${CriterionLocator05}    ${MyEventName}    clear=True
    Wait Until Keyword Succeeds    15s    3s    Textfield Value Should Be    ${CriterionLocator05}    ${MyEventName}
    Sleep    3s
